...
function Footer() {
  return (
    <footer className="w-full bg-stone-300 p-5 pb-32 text-13pxr">
      <div>
        <ul>
          <li>
            <p className="text-base font-semibold">(주)구조요청</p>
            <div className="item-container my-10pxr leading-[180%]">
              <ul>
                <li>
                  <p>
                    <span className="mr-2 text-[#6B6B6B]">대표자</span>
                    <span className="text-gray-700">이정현</span>
                  </p>
                  ...
                  <p>
                    ...
                    <span className="text-gray-700">112-82-12577</span>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <span className="text-gray-700">9teamhelp@sos.com</span>
                  </p>
                </li>
              </ul>
            </div>
